  ...
  return (
    <Box>
      <Box
        color={"#fff"}
        w={"100%"}
        bg="linear-gradient(to bottom, #F6422E, #FF6433)"
      >
        <Flex justifyContent={"space-evenly"}>
          <Flex
            ...
            fontSize={".8125rem"}
          >
            <Text padding={".25rem"} cursor={"pointer"} position="relative">
              Kênh Người Bán
              <Box
                as="span"
                height="100%"
          ...
          >
            <Flex alignItems={"center"} position={"relative"}>
              ...
              <Text padding={".25rem"} cursor={"pointer"}>
                Thông Báo
              </Text>
            </Flex>
            ...
            <Flex
              ...
              position={"relative"}
            >
              <Text w={"50%"} padding={".25rem"} cursor={"pointer"}>
                Đăng Ký
              </Text>
              <Box
                height="60%"
            ...
            <Box>
              ...
              <Flex>
                ...
                <GridItem
                  ...
                  m={".3125rem 15px  .3125rem  0"}
                >
                  Thẻ Đen Dán Ngân Hàng
                </GridItem>
              </Flex>
            </Box>
          </Flex>
          <Box cursor={"pointer"} fontSize={25} position={"relative"}>
